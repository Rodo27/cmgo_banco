	...
	<div class="col-xs-12">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-sm-12">
						<button class="btn btn-sm btn-success pull-right registrar" data-toggle="modal" onclick="abrirModal();"><i class="glyphicon glyphicon-plus-sign"></i> <b>AGREGAR CASO</b></button><br><br><br>
					</div>
					<div class="col-sm-4">
						<div class="input-group form-group">
						  	<span class="input-group-addon"><b>División</b></span>
						  	<select class="form-control" id="tabla_id_division" onChange="getAreas_tabla(this.value); getTemas_tabla(null);getTablaCasosClinicos();">
					...
					<div class="col-sm-4">
						<div class="input-group form-group">
						  	...
						  	<select class="form-control" id="tabla_id_area" onChange="getTemas_tabla(this.value); getTablaCasosClinicos();">
					...
					<div class="col-sm-4">
						<div class="input-group form-group">
						  	...
						  	<select class="form-control" id="tabla_id_tema" onChange="getTablaCasosClinicos();">
					...
					<div class="col-sm-4">
						<div class="input-group form-group">
						  	...
						  	<select class="form-control" id="tabla_id_estatus" onChange="getTablaCasosClinicos();">
					...
					<div class="col-sm-4">
						<div class="input-group form-group">
						  	...
						  	<select class="form-control" id="tabla_id_accion" onChange="getTablaCasosClinicos();">
				...
				<hr>
				<div class="row">
					<div class="col-xs-12" id="casos_clinicos_div">	
...
<div class="modal fade " tabindex="-1" role="dialog" id="RegistrarModal" style="overflow:scroll">
  	<div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
   	 	<div class="modal-content">
			  ...
			  <form id="registrar_caso" method="get" >
	      			...
	      			<div class="row">
					  			...
					  			<div class="col-sm-6">
  									<div class="input-group form-group">
										...
										<span class="input-group-addon"><b>División</b></span>
										<select class="form-control campo-division" id="id_division" name="id_division" onchange="getAreas(this.value);" required>
										</select>

									</div>
									<div class="input-group form-group">
										<span class="input-group-addon"><b>Área</b></span>
										<select class="form-control campo-area" id="id_area" name="id_area" onchange="getTemas(this.value);" required></select>
									</div>
									<div class="input-group form-group">
										<span class="input-group-addon"><b>Tema</b></span>
										<select class="form-control campo-tema" id="id_tema" name="id_tema" onChange="getPuntosClave_tabla(this.value);" required></select>
									</div>
									<div class="input-group form-group">
										<span class="input-group-addon"><b>Estatus</b></span>
										<select class="form-control campo-estatus" id="id_estatus" name="id_estatus" onChange="" required></select>
									</div>
									<div class="input-group form-group">
										<span class="input-group-addon"><b>Acción</b></span>
										<select class="form-control campo-accion" id="id_accion" name="id_accion" onChange="" required></select>
									</div>
								</div>
							...
							<div class="col-md-6" id="tabla_puntos">
								...
								<table class="table table-striped table-condensed tabla_pc" id="tabla_puntos_clave" disabled>
									<thead>
										<th>Numeración</th>
										<th>Punto Clave</th>
									</thead>
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<textarea class="form-control input-sm" id="add_casos_caso_clinico" style="margin: 0px -3.8125px 0px 0px; width: 478px; height: 146px;" name="add_casos_caso_clinico" rows="2" required></textarea>
								</div>
							</div>
								...
								<div class="form-group">
									...
									<div class="panel panel-primary">
										<div class="panel-body">
											...
											<table class="table table-bordered table-striped tabla_imagenes" id="tabla_imagenes_caso">
												<thead>
													<tr><th colspan="3" style="text-align: center"><b>IMAGENES DE CASO CLÍNICO</b></th>
													<input type="hidden" id="contador" value="1">
													<input type="hidden" id="arrayContador" name="imagenesPos">
												</tr></thead>
												<tbody></tbody>
											</table>
										...
										<div class="panel-footer" id="footer_boton_imagenes_pregunta">
											...
											<span class="btn btn-success btn-file btn-sm">AGREGAR IMAGEN
												<input type="file" accept=".jpg," name="agregar_img_caso" id="agregar_img_caso" onchange="agregar_imagen_cc_nuevo();"></input>
											</span>
											</div>
										</div>
									</div>
	      		...
	      		<div class="panel-footer">
				  	<div class="alert alert-success" id="registrado" style="display : none!important">
						...
						<strong>¡Se registró correctamente!</strong> El caso clínico esta guardado.
					</div>
					<div class="alert alert-danger" id="registrado_mal" style="display : none!important">
						<button type="button" class="close" data-dismiss="alert">&times;</button>
						<strong>Salió algo mal </strong> El caso clínico no fue guardado.
					</div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="EditarModal" >
  	<div class="modal-dialog modal-lg" role="document" style="overflow: scroll">
   	 	<div class="modal-content">
	      	<div class="modal-header" style="background-color:#605ca8;color:#fff;">
	        	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        	<h4 class="modal-title"><b>EDITAR CASO CLÍNICO</b></h4>
	      	</div>
			  <form id="editar_caso" method="get" >
	      		<div class="modal-body">
	      			<div class="row">
                      <div class="col-sm-4">
  							<div class="input-group form-group">
						...
						<div class="col-xs-8">
							<div class="form-group">
						    	...
						    	<textarea class="form-control input-sm medForm" id="caso_clinico" name="caso_clinico" rows="2" required></textarea>
						  	</div>
                        </div>
							...
							<label ><b></b></label>
							    <div class="panel panel-primary">
										<div class="panel-body">
											...
											<table class="table table-bordered table-striped tabla_imagenes" id="tabla_imagenes_caso_e">
												<thead>
													<tr><th colspan="3" style="text-align: center"><b>IMAGENES DE CASO CLÍNICO</b></th>
												</tr></thead>
												<tbody></tbody>
										...
										<div class="panel-footer" id="footer_boton_imagenes_pregunta">
											<div class="input-group form-group" style="text-align: center">
											<span class="btn btn-success btn-file btn-sm guardar">AGREGAR IMAGEN
												<input type="file" accept=".jpg" name="agregar_img_caso_e" id="agregar_img_caso_e" onchange="agregar_imagen_cc_editar();">
											</span>
											</div>
										</div>
									</div>
                        ...
                        <div class="col-xs-12">
						  	...
						  	<div class="form-group">
						    	...
						    	<textarea class="form-control input-sm medForm" id="upd_casos_modificacion" name="upd_casos_modificacion" rows="1" required></textarea>
						  	</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<h4><strong>PREGUNTAS DE ESTE CASO</strong> <button class="btn btn-sm btn-success pull-right guardar" type="button" onclick="agregarPregunta()"><i class="glyphicon glyphicon-plus-sign"></i> AGREGAR PREGUNTA</button></h4><br>
	      		...
	      		<div class="panel-footer">
				  	<div class="alert alert-success" id="editado" style="display : none!important">
						<button type="button" class="close" data-dismiss="alert">&times;</button>
						<strong>¡Se editó correctamente!</strong> Se guardaron los cambios.
					</div>
					<div class="alert alert-danger" id="editado_mal" style="display : none!important">
						<button type="button" class="close" data-dismiss="alert">&times;</button>
						<strong>Salió algo mal.</strong> No fueron guardados los cambios.
					</div>
	      			<input type="hidden" name="e_id_caso_clinico" id="e_id_caso_clinico" value="0">
...
<div class="modal fade" tabindex="-1" role="dialog" id="ModalVideo" >
    <div class="modal-dialog" role="document" style="width: 30%!important;">
      <div class="modal-content">
          <div class="modal-header" style="background-color:#605ca8;color:#fff;">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <div id="titulo_modalvideo" name="titulo_modal"><h4><b>Vista previa</b></h4></div>
          	</div>
	        	...
	        	<div class="row">
	        		<div class="col-xs-6">
	        			<h4 class="modal-title">
	        				<b>EDITAR PREGUNTA &mdash; CASOS CLINICOS</b>
	        			</h4>
	        		</div>
	        	</div>
	      	</div>
	      	
			  <form id="editar_pregunta_form" class="editar_pregunta_form_preg" method="get" >
			  <input type="hidden" id="id_caso" name="id_caso">
			  <input type="hidden" id="id_pregunta" name="id_pregunta">
			  <input type="hidden" id="id_temaIn" name="idTemaIn">
	      		<div class="modal-body">
	      			<div class="row">
	      				<div class="col-sm-4">
  							<div class="input-group form-group">
									...
									<span class="input-group-addon"><b>División</b></span>
									<select class="form-control campo-division-preg medForm" id="id_division2_preg" name="id_division" onchange="getAreas(this.value);" required>
									</select>
							...
							<div class="col-sm-4">
								<div class="input-group form-group">
									<span class="input-group-addon"><b>Área</b></span>
									<select class="form-control campo-area-preg medForm" id="id_area2_preg" name="id_area" onchange="getTemas(this.value);" required></select>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="input-group form-group">
									<span class="input-group-addon"><b>Tema</b></span>
									<select class="form-control campo-tema-preg medForm" id="id_tema2_preg" name="id_tema" onChange="getPuntosClave_tabla_editar_preg(this.value);" required></select>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="row">
									<div class="col-sm-12">
										<div class="input-group form-group">
											...
											<select class="form-control campo-complejidad-cognitiva-preg medForm" id="id_complejidad_cognitiva2_preg" name="upd_preguntas_id_complejidad_cognitiva" required></select>
										</div>
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Periodo de la vida</b></span>
											<select class="form-control campo-periodo-preg medForm" id="id_periodo_vida2_preg" name="upd_preguntas_id_periodo_vida" required>
											</select>
										</div>
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Estatus</b></span>
											<select class="form-control campo-estatus-preg medForm" id="estatus_list_preg" name="id_estatus">
											</select>
										</div>
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Acción</b></span>
											<select class="form-control campo-accion-preg medForm" id="accion_list_preg" name="id_accion">
											</select>
										</div>
							...
							<div class="col-md-6" id="tabla_puntos">
								<input type="hidden" id="puntos_clave_arreglo_preg"  name="puntos_clave" class="puntos_clave_arreglo_preg">
								<table class="table table-striped table-condensed tabla_pc-preg  medForm" id="tabla_puntos_clave_e_preg">
									<thead>
										<th>Numeración</th>
										<th>Punto Clave</th>
										<th>check</th>
						...
						<div class="row">
							<div class="col-md-2 col-md-offset-5">
								<button class="btn btn-primary collapsed glyphicon glyphicon-eye-open" id="ocul_ver" value="false" onClick="verOcultarCalibracion(this.value);"  type="button" data-toggle="collapse" data-target="#dif-discri , #infit-outfit-dif-disc" aria-expanded="false" aria-controls="dif-discri , infit-outfit-dif-disc">
													Calibración
								</button>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="form-group">
									...
									<textarea class="form-control input-sm medForm" id="pregunta2" name="upd_preguntas_pregunta" rows="1" required></textarea>
								</div>
							</div>
							<div class="col-xs-12">
								<div class="row">
									<div class="col-xs-8">
										<div class="input-group form-group">
											...
											<input type="text" class="form-control medForm" id="opcion_a2" name="upd_preguntas_opcion_a" required>
										</div>
									</div>
									...
									<div class="col-xs-8">
										<div class="input-group form-group">
											...
											<input type="text" class="form-control  medForm" id="opcion_b2" name="upd_preguntas_opcion_b" required>
									...
									<div class="col-xs-8">
										<div class="input-group form-group">
											...
											<input type="text" class="form-control  medForm" id="opcion_c2" name="upd_preguntas_opcion_c" required>
										</div>
									</div>
									...
									<div class="col-xs-8">
										<div class="input-group form-group">
											...
											<input type="text" class="form-control  medForm" id="opcion_d2" name="upd_preguntas_opcion_d" required>
										</div>
									</div>
									...
									<div class="col-xs-8">
										<div class="input-group form-group">
											...
											<input type="text" class="form-control  medForm" id="opcion_e2" name="upd_preguntas_opcion_e">
										</div>
									</div>
									...
									<div class="col-xs-4">
										<div class="progress">
											<div class="progress-bar" role="progressbar" aria-valuenow="60"
												...
												<span class="porcentaje_barra  porcentaje_barra"></span>
											</div>
										</div>
									</div>
							...
							<div class="col-sm-4">
								<div class="input-group form-group">
									...
									<select class="form-control  medForm" id="respuesta2" name="upd_preguntas_respuesta" required>
							...
							<div class="col-sm-8">
								<div class="input-group form-group">
									...
									<select class="form-control campo-bibliografia-preg  medForm" id="id_bibliografia2_preg" name="upd_preguntas_id_bibliografia" required><?=$bibliografia;?></select>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="input-group form-group">
									...
									<input type="text" class="form-control  medForm" id="capitulo2" name="upd_preguntas_capitulo">
								</div>
							</div>
                            ...
                            <div class="col-sm-6 text-center">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-footer guardar" id="footer_boton_imagenes_pregunta"><div class="input-group form-group" style="text-align: center"><span class="btn btn-success btn-file btn-sm">AGREGAR NUEVA IMAGEN<input type="file" accept=".jpg" name="agregar_img_pregunta" id="agregar_img_pregunta_e" onchange="agregar_imagen_pregunta(1);"></span></div></div>
                                </div>
							...
							<div class="col-xs-12" id="div_pregunta_examen_boton">
	      						<div class="form-group">
									<button class="btn btn-primary collapsed" id="actual_examen" type="button" onClick="getContenidoActualPregunta();"data-toggle="collapse" data-target="#div_pregunta_examen" aria-expanded="false" aria-controls="div_pregunta_examen">
							...
							<div class="collapse" id="div_pregunta_examen" aria-expanded="false" style="height: 0px;">
								...
								<div class="col-xs-12">
										<div class="form-group">
											<label for="caso_clinico_examen_actual">Caso clínico</label>
											<textarea class="form-control input-sm examen_actual" id="caso_clinico_examen_actual" rows="1" disabled="" style="margin: 0px 27.3906px 0px 0px; height: 90px; width: 952px;"></textarea>
										</div>
									</div>
									<div class="col-xs-12">
										<div class="form-group">
											<label for="pregunta_examen_actual">Pregunta</label>
											<textarea class="form-control input-sm examen_actual" id="pregunta_examen_actual" rows="1" disabled="" style="margin: 0px 27.3906px 0px 0px; height: 90px; width: 952px;"></textarea>
										</div>
									</div>
		      				...
		      				<div class="col-xs-10 col-xs-offset-1">
								<div class="row">
									...
									<table class="table table-striped table-bordered table-sm">
									  ...
									  <tbody>
									    <tr class="success">
									      <th scope="row" class="medForm">Con referencia al reactivo en su conjunto</th>
					...
					<div class="panel-footer">
							<div class="alert alert-success" id="registrado_editar" style="display : none!important">
								<button type="button" class="close" data-dismiss="alert">&times;</button>
								<strong>¡Se registró correctamente!</strong> Su pregunta esta guardada.
							</div>
							<div class="alert alert-danger" id="registrado_mal_editar" style="display : none!important">
								<button type="button" class="close" data-dismiss="alert">&times;</button>
   	 	...
   	 	<div class="modal-content">
	      	<div class="modal-header" style="background-color:#605ca8;color:#fff;">
	        	...
	        	<div class="row">
	        		<div class="col-xs-6">
	        			<h4 class="modal-title">
	        				<b>REGISTRAR PREGUNTA &mdash; CASOS CLINICOS</b>
	        			</h4>
	        		</div>
	        	</div>
	      	</div>
	      	
			  <form id="registro_caso_clinico" method="get" >
			  <input type="hidden" id="id_caso_e" name="id_caso_e">
	      		<div class="modal-body">
	      			<div class="row">
						...
						<input type="hidden" class="form-control" id="id_division2_e2" name="id_division">
						<input type="hidden" class="form-control" id="id_area2_e2" name="id_area">
						<input type="hidden" class="form-control" id="id_tema2_e2" name="id_tema">
						<input type="hidden" class="form-control" id="id_complejidad_cognitiva2_e" name="id_complejidad_cognitiva">
						<input type="hidden" class="form-control" id="id_periodo_vida2_e" name="upd_preguntas_id_periodo_vida">
						<input type="hidden" class="form-control" id="estatus_list_e2" name="id_estatus">
						<input type="hidden" class="form-control" id="accion_list_e2" name="id_accion">
						...
						<div class="row">
							<!-- Bloque para INFIT, OUTFIT, DIF, DISCR, Dificultad y Discriminación -->
                                ...
                                <div class="col-xs-12"><hr></div> <!-- Linea divisora -->
									...
									<div class="col-sm-12">
										<label for="id_caso" style="text-align: center"><h4><b>Caso</b></h4></label>
										<input type="hidden" class="form-control list-casos" id="id_caso_p" name="id_caso" style="height:100px;max-width: 100%;box-sizing: border-box;white-space: normal;word-wrap: break-word;"  required="" onChange="getImagesCasoEspecifico(this.value);">
									</div>
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-body">
                                            ...
                                            <table class="table tabla_imagenes" id="tabla_imagenes_caso">
                                                <thead>
							...
							<div class="col-xs-12">
								<div class="form-group">
									<label for="upd_preguntas_pregunta">Pregunta</label>
									<textarea class="form-control input-sm" id="pregunta2_e" name="upd_preguntas_pregunta" rows="1" required></textarea>
								</div>
							</div>
							<div class="col-xs-7">
									<div class="col-xs-12">
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Opción A)</b></span>
											<input type="text" class="form-control" id="opcion_a2_e" name="upd_preguntas_opcion_a" required>
										</div>
									</div>
									...
									<div class="col-xs-12">
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Opción B)</b></span>
											<input type="text" class="form-control" id="opcion_b2_e" name="upd_preguntas_opcion_b" required>
									...
									<div class="col-xs-12">
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Opción C)</b></span>
											<input type="text" class="form-control" id="opcion_c2_e" name="upd_preguntas_opcion_c" required>
										</div>
									</div>
									...
									<div class="col-xs-12">
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Opción D)</b></span>
											<input type="text" class="form-control" id="opcion_d2_e" name="upd_preguntas_opcion_d" required>
										</div>
									</div>
									...
									<div class="col-xs-12">
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Opción E)</b></span>
											<input type="text" class="form-control" id="opcion_e2_e" name="upd_preguntas_opcion_e">
										</div>
									</div>
							</div>
							<div class="col-xs-5">
								...
								<div class="col-sm-12 text-center">
									<div class="panel panel-primary">
										<div class="panel-body">
											...
											<table class="table table-bordered table-striped tabla_imagenes" id="tabla_imagenes_pregunta_e">
												<thead>
													<th colspan="3" style="text-align: center"><b>IMAGENES DE LA PREGUNTA</b></th>
													<input type="hidden" id="contador" value="1">
													<input type="hidden" id="arrayContador" name="imagenesPos">
										...
										<div class="panel-footer" id="footer_boton_imagenes_pregunta">
											<div class="input-group form-group" style="text-align: center">
												<span class="btn btn-success btn-file btn-sm">AGREGAR NUEVA IMAGEN<input type="file" accept=".jpg" name="agregar_img_pregunta" id="agregar_img_pregunta" onchange="agregar_imagen_pregunta_nuevo();"></span>
											</div>
										</div>
									</div>
							...
							<div class="col-sm-4">
								<div class="input-group form-group">
									<span class="input-group-addon"><b>Respuesta</b></span>
									<select class="form-control" id="respuesta2_e" name="upd_preguntas_respuesta" required>
										<option value="A">A</option>
										<option value="B">B</option>
										<option value="C">C</option>
										<option value="D">D</option>
							...
							<div class="col-sm-8">
								<div class="input-group form-group">
									<span class="input-group-addon"><b>Bibliografía</b></span>
									<select class="form-control campo-bibliografia" id="id_bibliografia2_e" name="upd_preguntas_id_bibliografia" required></select>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="input-group form-group">
									<span class="input-group-addon"><b>Capítulo</b></span>
									<input type="text" class="form-control" id="capitulo2_e" name="upd_preguntas_capitulo">
								</div>
							</div>
					...
					<div class="panel-footer">
							<div class="alert alert-success" id="registrado_preg" style="display : none!important">
								<button type="button" class="close" data-dismiss="alert">&times;</button>
								<strong>¡Se registró correctamente!</strong> Su pregunta esta guardada.
							</div>
							<div class="alert alert-danger" id="registrado_mal_preg" style="display : none!important">
								<button type="button" class="close" data-dismiss="alert">&times;</button>
								<strong>Salió algo mal</strong> Su pregunta no fue guardada.
							</div>
	      			<button type="submit" class="btn btn-primary" ><i class="glyphicon glyphicon-floppy-disk"></i> <b>GUARDAR</b></button>
					  <button type="button" class="btn btn-success pull-right" onclick="abrirAprobar();"><i class="glyphicon glyphicon-floppy-disk"></i> <b>APROBAR REACTIVO</b></button>
				</form>
    ...
    <div class="modal-dialog" role="document" style="width: 30%!important;">
      <div class="modal-content">
          <div class="modal-header" style="background-color:#605ca8;color:#fff;">
            ...
            <div class="modal-body text-center" id="cuerpo_autorizacion_modal5">
    ...
    <div class="modal-dialog" role="document" style="width: 30%!important;">
      <div class="modal-content">
          <div class="modal-header" style="background-color:#605ca8;color:#fff;">
            ...
            <div class="modal-body text-center" id="cuerpo_autorizacion1">
