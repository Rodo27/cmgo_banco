	...
	<div class="col-xs-12">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-sm-12">
						<button class="btn btn-sm btn-success pull-right registrar" data-toggle="modal" onclick="abrirModal();"><i class="glyphicon glyphicon-plus-sign"></i> <b>AGREGAR PREGUNTA</b></button><br><br><br>
					</div>
					<div class="col-sm-4">
				...
				<hr>
				<div class="row">
					<div class="col-xs-12" id="preguntas_contenedor_cc">	
...
<div class="modal fade" tabindex="-1" role="dialog" id="Modal_editar">
  	<div class="modal-dialog modal-lg" role="document">
			...
			<form id="editar_pregunta_form" method="get" >
	      			...
	      			<div class="row">
	      				<div class="col-sm-4">
  							<div class="input-group form-group">
									...
									<span class="input-group-addon"><b>División</b></span>
									<select class="form-control campo-division" id="id_division2" name="id_division" onchange="getAreas(this.value);" required disabled>
									</select>
							...
							<div class="col-sm-4">
								<div class="input-group form-group">
									<span class="input-group-addon"><b>Área</b></span>
									<select class="form-control campo-area" id="id_area2" name="id_area" onchange="getTemas(this.value);" required disabled></select>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="input-group form-group">
									<span class="input-group-addon"><b>Tema</b></span>
									<select class="form-control campo-tema" id="id_temas" name="id_tema" onChange="getPuntosClave_tabla ditar(this.value);" required disabled></select>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="row">
									<div class="col-sm-12">
										<div class="input-group form-group">
											...
											<select class="form-control campo-complejidad-cognitiva medForm" id="id_complejidad_cognitiva2" name="upd_preguntas_id_complejidad_cognitiva" required></select>
										</div>
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Periodo de la vida</b></span>
											<select class="form-control campo-periodo medForm" id="id_periodo_vida2" name="upd_preguntas_id_periodo_vida" required>
											</select>
										</div>
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Estatus</b></span>
											<select class="form-control campo-estatus medForm" id="estatus_list" name="id_estatus">
											</select>
										</div>
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Acción</b></span>
											<select class="form-control campo-accion medForm" id="accion_list" name="id_accion">
											</select>
										</div>
						...
						<div class="row">
							<!-- Bloque para INFIT, OUTFIT, DIF, DISCR, Dificultad y Discriminación -->
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select class="form-control list-casos medForm" id="id_caso_e" name="id_caso" style="height:100px;max-width: 100%;box-sizing: border-box;white-space: normal;word-wrap: break-word;"  required=""><option  selected=""></option></select>
                                </div>
							...
							<div class="col-sm-8">
								<div class="input-group form-group">
									...
									<select class="form-control campo-bibliografia medForm" id="id_bibliografia2" name="upd_preguntas_id_bibliografia" required><?=$bibliografia;?></select>
								</div>
							</div>
  	...
  	<div class="modal-dialog modal-lg" role="document">
   	 	<div class="modal-content">
			  ...
			  <div class="embed-responsive embed-responsive-16by9">
					<iframe class="embed-responsive-item" src="http://localhost/banco_v2/videos/casos_clinicos/2/hola.mp4"></iframe>
				</div>
			</div>
			<div class="panel-footer">		
	      	</div>
	      			...
	      			<div class="row">
	      				<div class="col-sm-4">
  							<div class="input-group form-group">
									...
									<span class="input-group-addon"><b>División</b></span>
									<select class="form-control campo-division" id="id_division2_e" name="id_division" onchange="getAreas(this.value);" required>
									</select>
							...
							<div class="col-sm-4">
								<div class="input-group form-group">
									<span class="input-group-addon"><b>Área</b></span>
									<select class="form-control campo-area" id="id_area2_e" name="id_area" onchange="getTemas(this.value);" required></select>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="input-group form-group">
									<span class="input-group-addon"><b>Tema</b></span>
									<select class="form-control campo-tema" id="id_tema2_e" name="id_tema" onChange="getPuntosClave_tabla(this.value);getCasos(this.value);" required></select>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="row">
									<div class="col-sm-12">
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Complejidad cognitiva</b></span>
											<select class="form-control campo-complejidad-cognitiva" id="id_complejidad_cognitiva2_e" name="id_complejidad_cognitiva" required></select>
										</div>
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Periodo de la vida</b></span>
											<select class="form-control campo-periodo" id="id_periodo_vida2_e" name="upd_preguntas_id_periodo_vida" required>
											</select>
										</div>
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Estatus</b></span>
											<select class="form-control campo-estatus" id="estatus_list_e" name="id_estatus">
											</select>
										</div>
										<div class="input-group form-group">
											<span class="input-group-addon"><b>Acción</b></span>
											<select class="form-control campo-accion" id="accion_list_e" name="id_accion">
											</select>
										</div>
						...
						<div class="row">
							<!-- Bloque para INFIT, OUTFIT, DIF, DISCR, Dificultad y Discriminación -->
                                ...
                                <div class="col-xs-12"><hr></div> <!-- Linea divisora -->
									...
									<div class="col-sm-8">
										<label for="id_caso"><b>Caso</b></label>
										<select class="form-control list-casos" id="id_caso" name="id_caso" style="height:100px;max-width: 100%;box-sizing: border-box;white-space: normal;word-wrap: break-word;"  required="" onChange="getImagesCasoEspecifico(this.value);"><option  selected=""></option></select>
									</div>
							...
							<div class="col-sm-8">
								<div class="input-group form-group">
									<span class="input-group-addon"><b>Bibliografíaaaa</b></span>
									<select class="form-control campo-bibliografia" id="id_bibliografia2_e" name="upd_preguntas_id_bibliografia" required>
									</select>
								</div>
							</div>
