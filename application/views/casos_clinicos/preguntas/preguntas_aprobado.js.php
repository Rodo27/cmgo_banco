...
<script type="text/javascript">
  ...
  function verPreguntaAprobado(id_pregunta){
    ...
    $.ajax({
        url:"<?php echo base_url('index.php/Casos_clinicos/get_preguntas_aprobadoID')?>",
        type:'GET',
        dataType:"JSON",
        ...
        success:function(data){
          ...
          $("#caso_aprobado").val(data.contenido);
  ...
  function getTabla(){
    ...
    var version_examen= $("#version_examen").val();
     $.ajax({
        url:"<?php echo base_url('index.php/Casos_clinicos/get_preguntas_aprobado')?>",
        type:'GET',
        dataType:"JSON",
