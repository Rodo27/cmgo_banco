	...
	<div class="col-xs-12">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="box-title"><b>LISTADO DE REACTIVOS APROBADOS CC</b></h3>
			</div>
      		...
      		<div class="modal-body">
      			<div class="row">
					<div class="row">
					  	...
					  	<div class="col-xs-8 col-xs-offset-2">
					  		<div class="input-group form-group">
							  	<span class="input-group-addon"><b>Caso Clínico</b></span>
							  	<!-- <input type="text" class="form-control" disabled id="caso_aprobado"> -->
							  	<textarea class="form-control input-sm" id="caso_aprobado" rows="4" disabled></textarea>
							</div>
					  	</div>
					  	<div class="col-xs-8 col-xs-offset-2">
					  		<div class="input-group form-group">
