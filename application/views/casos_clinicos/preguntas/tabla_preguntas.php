<!-- <script type="text/javascript">
	...
	var tableP=$("#tabla_preguntas").DataTable({"search":{"search":search},"aaSorting":[],"columnDefs":[{"targets":[9],"orderable":false}],"iDisplayLength":100,"columns":[{"width":"50px"},null,null,null,null,null,null,null],"displayStart":x,"dom":'<"top"i>rf<"bottom"tlp><"clear">'});

	$('#tabla_preguntas').on('search.dt', function() {
...
<script type="text/javascript">
	...
	var tableP=$("#tabla_preguntas").DataTable({initComplete: function() {$(this.api().table().container()).find('input').parent().wrap('<form>').parent().attr('autocomplete', 'off');},"aaSorting":[],"iDisplayLength":100,"columnDefs":[{"targets":[9],"orderable":false}]});
</script>
